...
fn vs_main(
    ...
    out.center = center;
    out.index = counter.count + data.index;
    return out;
}
...
macro_rules! CYLINDER_PICKER_SHADER { () => {"
struct CameraUniform {{
    view_pos: vec4<f32>,
    view_proj: mat4x4<f32>,
}}
...
fn vs_main(
    ...
    out.world_pos = world_position;
    out.index = counter.count + pos.index + {};
    ...
    fn new(
        ...
        let cyl_shader = wgpu::ShaderModuleDescriptor {
            ...
            source: wgpu::ShaderSource::Wgsl(
                format!(CYLINDER_PICKER_SHADER!(), geometry.positions.len()).into(),
            ),
        };
